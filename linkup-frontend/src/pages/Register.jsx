...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 bg-white/80 backdrop-blur-xl p-10 rounded-[2rem] shadow-xl shadow-indigo-500/5 border border-white z-10 mt-8 mb-8">
        <div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-sm text-gray-600">
            <p>
              By registering, you agree to share your location for nearby user discovery.
              Your location data is used only for matching purposes and is not stored permanently.
            </p>
          </div>
